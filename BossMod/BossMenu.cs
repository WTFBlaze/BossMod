...
namespace BossMod
{
    ...
    {
        static BossMenu() => ClassInjector.RegisterTypeInIl2Cpp<BossMenu>();
        public BossMenu(IntPtr ptr) : base(ptr) { }
        ...
        public string menuTitleText = "<size=35><b><color=red>BossMod</color></b></size>";
        public string subTitleText = "<size=25><b><color=#7d0000>by Blaze, Cheetos & Mora</color></b></size>";
        ...
        public void Start()
        {
            // add menu ui register code here
        }
